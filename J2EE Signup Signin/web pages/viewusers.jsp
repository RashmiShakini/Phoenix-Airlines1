...
<tr><th>First Name</th><th>Last Name</th><th>ID Card Number</th><th>UserName</th><th>Email</th><th>Password</th><th>Confirm Password</th><th>Phone Number</th><th>Address</th><th>Edit</th><th>Delete</th></tr>
<c:forEach items="${list}" var="u">
	<tr><td>${u.getFirstName()}</td><td>${u.getLastName()}</td><td>${u.getIDCardNumber()}</td><td>${u.getUserName()}</td><td>${u.getEmail()}</td><td>${u.getPassword()}</td><td>${u.getConfirmPassword()}</td><td>${u.getPhoneNumber()}</td><td>${u.getAddress()}</td><td><a href="editform.jsp?id=${u.getId()}">Edit</a></td><td><a href="deleteuser.jsp?id=${u.getId()}">Delete</a></td></tr>
</c:forEach>
</table>
